...
def beat(beat_id: str, start: int, end: int, **updates: object) -> dict:
    value = {
        ...
        "component_entry_seconds": 0.4,
        "stable_hold_seconds": 0.8,
        "container_strategy": "new",
        "exit_mode": "transition",
...
valid = {
    ...
    "beats": [
        beat(
            ...
            group_exit_frame=96,
            container_strategy="shared-batch",
            exit_mode="group-exit",
            density="dense",
            alignment="left",
...
invalid = {
    ...
    "beats": [
        beat(
            ...
            component_entry_seconds=1.2,
            stable_hold_seconds=0.2,
            spoken_trigger="",
            container_strategy="retain-update",
            exit_mode="group-exit",
